...
const btnItaly = document.getElementById("italian")
const btnSouthEastAsian = document.getElementById("southEastAsian")
const btnBalanced = document.getElementById("balanced")
const btnHighFiber = document.getElementById("highFiber")
const btnSouthAmerican = document.getElementById("southAmerican")
const btnLowcarb = document.getElementById("lowCarb")
const btnAmerican = document.getElementById("american")
const btnChinese = document.getElementById("chinese")
const btnSortByPrepAsc = document.getElementById("longPrepTime")
const btnSortByPrepDesc = document.getElementById("kortPrepTime")
...
const recipes = [
  ...
  },
  {
    ...
    image: './recipe-images/curry-crusted-fish.jpg'
  },
  {
    name: 'Meat Stock',
    cuisineType: 'american',
  ...
  },
  {
    ...
    image: './recipe-images/clear-meat-broth.jpg'
  },
  {
...
btnItaly.addEventListener("click", () => {
  const italianRecipes = recipes.filter((recipe) => recipe.cuisineType.includes("italian"))
  showRecipeItem(italianRecipes)
})

btnBalanced.addEventListener("click", () => {
  const balancedRecipes = recipes.filter((recipe) => recipe.cuisineType.includes("Balanced"))
  showRecipeItem(balancedRecipes)
})

btnHighFiber.addEventListener("click", () => {
  const highFiberRecipes = recipes.filter((recipe) => recipe.cuisineType.includes("High-Fiber"))
  showRecipeItem(highFiberRecipes)
})

btnSouthAmerican.addEventListener("click", () => {
  const southAmericanRecipes = recipes.filter((recipe) => recipe.cuisineType.includes("south-american"))
  showRecipeItem(southAmericanRecipes)
})

btnLowcarb.addEventListener("click", () => {
  const lowCarbRecipes = recipes.filter((recipe) => recipe.cuisineType.includes("Low-Carb"))
  showRecipeItem(lowCarbRecipes)
})

btnAmerican.addEventListener("click", () => {
  const americanRecipes = recipes.filter((recipe) => recipe.cuisineType.includes("american"))
  showRecipeItem(americanRecipes)
})

btnChinese.addEventListener("click", () => {
  const chineseRecipes = recipes.filter((recipe) => recipe.cuisineType.includes("chinese"))
  showRecipeItem(chineseRecipes)
})

btnSouthEastAsian.addEventListener("click", () =>{
